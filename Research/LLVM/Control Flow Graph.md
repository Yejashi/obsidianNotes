...
### Structure
- Nodes (Basic Blocks): Each basic block is a single node in the CFG. Basic blocks encapsulate sequences of instructions with a single entry point and a single exit point.