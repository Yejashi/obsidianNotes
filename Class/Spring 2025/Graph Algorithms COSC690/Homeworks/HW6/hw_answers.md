...
b.) It suffices to arbitrarily set s and let the other vertices play the role of t because not matter the value of s, you will eventually have to consider the verticies for t that produce the minimum max flow 
