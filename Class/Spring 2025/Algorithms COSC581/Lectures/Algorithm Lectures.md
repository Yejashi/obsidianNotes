...
- **DP Table:**  
    The table rows represent remaining budget intervals (e.g., [30,59], [60,70]) and columns represent the possible decisions. The table records the reliability values and marks the optimal decision d1∗d_1^*d1∗​.
