...
The Fast Fourier Transform. Explain where in its derivation the FFf em- ploys mathematical symmetry to multiply two polynomials of degree n in O(nlogn) time.