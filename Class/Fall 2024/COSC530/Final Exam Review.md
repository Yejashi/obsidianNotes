...
- When a processor wants to read or write a memory location, it sends a request to the directory, which checks the status of the memory block and notifies the relevant caches.
