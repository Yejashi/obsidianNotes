...
It divides a large problem into smaller chunks, or "strips," which are processed sequentially, but within each strip, data is processed in parallel or vectorized.
