...
- Given an HMM $M$ and an observation sequence $O = O_1 O_2 \dots O_T​$​, what is the **most likely hidden state sequence** $Q = q_1 q_2 \dots q_TQ=q1​q2​…qT​ that produced OOO?
