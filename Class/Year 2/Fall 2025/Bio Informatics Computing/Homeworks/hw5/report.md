...
The MUSCLE tree and the Clustal tree are basically the same tree. Any differences are tiny (mostly branch lengths rounded slightly differently), so for practical purposes they’re identical.
